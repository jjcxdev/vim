...
const CommandDisplay = () => {
  ...
  return (
    <div className="max-w-[950px] h-full flex flex-col">
      ...
      <div className="border h-60 border-gray-700 px-4 py-2 overflow-scroll scroll-box grid grid-cols-3 rounded-lg">
            ...
            <div className="overflow-y-scroll">
              {keys.map((key: string) => {
                ...
                return actionDescription ? (
                  <div
                    className="flex py-1 whitespace-nowrap flex-row items-center text-sm gap-2"
                    key={key}
                  >
