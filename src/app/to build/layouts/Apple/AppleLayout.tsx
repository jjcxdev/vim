...
import { KeyConfig } from "../keymaps/macbook";
...
export default function MacBookLayout({ keymap }: MacBookLayoutProps) {
  ...
  //console.log("DANCE_01 action", keymap["DANCE_01"]?.actions[0]);
      ...
      <div className="keyboard-row gap-2 flex">
        <Key
          ...
          isPressed={
            ...
            false
          } className="key-apple-return-caps"
        />
        <Key
          {...(keymap["DANCE_21"] || {})}
          isPressed={
