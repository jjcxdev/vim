...
export default function IsoLayout({ keymap = {} }: IsoLayoutProps) {
  ...
  return (
    ...
    <main className="flex justify-center flex-col gap-2 min-w-fit">
      ...
      <div className="keyboard-row gap-2 flex">
        ...
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-iso-del"
        />
      </div>
      ...
      <div className="keyboard-row gap-2 flex">
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-iso-tab"
        />
        <Key
          {...(keymap["DANCE_11"] || {})}
          isPressed={
      ...
      {/* ----- Third Row ----- */}
      <div className="keyboard-row gap-2 flex relative">
        <Key
          {...(keymap["DANCE_20"] || {})}
          isPressed={
      ...
      <div className="keyboard-row gap-2 flex">
        ...
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-iso-rshift"
        />
      </div>
