...
export default function AnsiLayout({ keymap = {} }: AnsiLayoutProps) {
  ...
  return (
    ...
    <main className="flex justify-center flex-col gap-2 min-w-fit">
      ...
      {/* ----- UPPER Row ----- */}
      <div className="keyboard-row pb-4 gap-2 justify-between w-full flex">
        <Key
          {...(keymap["DANCE_50"] || {})}
          isPressed={
        ...
        <div className="flex gap-1">
          <Key
            {...(keymap["DANCE_51"] || {})}
            isPressed={
              keymap["DANCE_51"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_52"] || {})}
            isPressed={
              keymap["DANCE_52"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_53"] || {})}
            isPressed={
              keymap["DANCE_53"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_54"] || {})}
            isPressed={
              keymap["DANCE_54"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
        </div>
        <div className="flex gap-1">
          <Key
            {...(keymap["DANCE_55"] || {})}
            isPressed={
              keymap["DANCE_55"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_56"] || {})}
            isPressed={
              keymap["DANCE_56"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_57"] || {})}
            isPressed={
              keymap["DANCE_57"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_58"] || {})}
            isPressed={
              keymap["DANCE_58"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
        </div>
        <div className="flex gap-1">
          <Key
            {...(keymap["DANCE_59"] || {})}
            isPressed={
              keymap["DANCE_59"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_5A"] || {})}
            isPressed={
              keymap["DANCE_5A"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_5B"] || {})}
            isPressed={
              keymap["DANCE_5B"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
          <Key
            {...(keymap["DANCE_5C"] || {})}
            isPressed={
              keymap["DANCE_5C"]?.actions.some((action) => keyState[action]) ||
              false
            } mode={currentMode}
          />
        </div>
      ...
      <div className="keyboard-row gap-2 flex">
        ...
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-del"
        />
      </div>
      ...
      <div className="keyboard-row gap-2 flex">
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-shift"
        />
        <Key
          {...(keymap["DANCE_31"] || {})}
          isPressed={
        ...
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-rshift"
        />
      </div>
      ...
      <div className="keyboard-row gap-2 flex">
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-ctrl"
        />
        <Key
          {...(keymap["DANCE_41"] || {})}
          isPressed={
        ...
        <Key
          ...
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-space"
        />
        <Key
          {...(keymap["DANCE_45"] || {})}
          isPressed={
            ...
            false
          } mode={currentMode} className="key-ansi-alt"
        />
        <Key
          {...(keymap["DANCE_46"] || {})}
          isPressed={
